...
def test_negations_original():
    ...
    print("ТЕСТИРОВАНИЕ ОРИГИНАЛЬНЫХ ЗАДАЧ С ОТРИЦАНИЯМИ")
    print("=" * 60)
...
# ===================================================================
# 2. Только один объект обладает свойством («только Маша»)
# ===================================================================
...
def test_transitivity():
    test_cases = [
        "Если A старше B и B старше C, то A старше C. Маша старше Кати, а Катя старше Лены. Докажи, что Маша старше Лены."
    ]
...
# ===================================================================
# 11. Цепочка импликаций (гипотетический силлогизм)
# ===================================================================
